...
describe("plugin-utils", () => {
    describe("throwUnexpectedConfigError", () => {
        it("should throw with all the options", () => {
            function throwError() {
        ...
        it("should throw with message, packageName, and githubRepo", () => {
            function throwError() {
                throwUnexpectedConfigError({
                    message: "Can't find file-loader in the webpack config!",
                    packageName: "craco-less",
        ...
        it("should throw with message and packageName", () => {
            function throwError() {
                throwUnexpectedConfigError({
                    message: "Can't find file-loader in the webpack config!",
                    packageName: "craco-less"
        ...
        it("should throw with message and githubIssueQuery", () => {
            function throwError() {
                throwUnexpectedConfigError({
                    message: "Can't find file-loader in the webpack config!",
                    githubIssueQuery: "webpack+file-loader"
